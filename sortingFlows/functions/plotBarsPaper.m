...
p1 = plot(xPlot,yList,symbol,'Color',[0.5 0.5 0.5],'LineWidth',3.6,'MarkerSize',16); hold on;
...
if(isfield(opts,'err') & strcmp(opts.err,'SEM'))
    ...
    err = errorbar(nanmean(x),nanmean(yList),nanstd(yList),'LineWidth',3.6,'CapSize',30,'MarkerSize',40,'Color',color);
end
